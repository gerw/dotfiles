...
if [ "$color_prompt" = yes ]; then
	...
	PS1="${debian_chroot:+($debian_chroot)}$red$short$black$colon$blue\w $sign$black "
	unset shortusr shorthost short colon sign
	unset red black green yellow blue
else
